<template>
    ...
    <div>
        ...
        <h5 class="listTitle">烟感列表</h5>
        <!-- 数据列表 -->
        <div class="party-table">
            <el-table :data="tableData" height="100%" @row-click="smokingTips">
...
import smokingTips from "../../../components/tips/smokingTips";
export default {
    name: "smokeSense",
    components: {
        smokingTips,
