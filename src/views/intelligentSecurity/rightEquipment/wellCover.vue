<template>
    ...
    <div>
        ...
        <h5 class="listTitle">井盖列表</h5>
        <!-- 数据列表 -->
        <div class="party-table">
            <el-table :data="tableData" height="100%" @row-click="coverTips">
...
import coverTips from "../../../components/tips/coverTips";
export default {
    name: "wellCover",
    components: {
        coverTips,
    ...
    methods: {
        ...
        //  请求后端井盖接口
        async getCoverList() {
            const res = await this.$Http.coverList(this.info);
            if (res.code == 0) {
